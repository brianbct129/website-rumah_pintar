    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-2">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <img class="w-100 rounded wow zoomIn" data-wow-delay="0.9s" src="img/landingpage1.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="img/landingpage2.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row g-5">
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Maksimalkan Potensi Bisnis Anda dengan Landing Page</h1>
                    </div>
                    <div class="row gx-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <p class="mb-4">Optimalkan bisnis online Anda dengan landing page yang efektif! Dapatkan paket yang sesuai dengan kebutuhan Anda, termasuk hosting, pemeliharaan, dan bonus tambahan. Segera hubungi kami untuk informasi lebih lanjut dan manfaatkan landing page sebagai peluang bisnis baru Anda serta memperkuat citra merek Anda</p>
                    <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                        <div class="bg-primary d-flex align-items-center justify-content-center rounded" style="width: 60px; height: 60px;">
                            <i class="fa fa-phone-alt text-white"></i>
                        </div>
