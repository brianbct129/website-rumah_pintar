        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                ...
                <?php
                  ...
                  // Mengganti garis bawah dengan spasi dan mengubah huruf pertama menjadi huruf kapital
                  $pageTitle = ucfirst(str_replace('_', ' ', $currentPage));

                  // Output heading dinamis
                  echo '<h1 class="display-4 text-white animated zoomIn">' . $pageTitle . '</h1>';
                  ?>
                </div>
            </div>
        </div>
